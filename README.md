...
This component provides a NATS client for reading and sending messages from/to a  link:https://nats.io[NATS] server. The client supports both Core NATS as well as JetStream.
...
<dependency>
  ...
  <artifactId>vertx-nats-client</artifactId>
...
----
compile io.vertx:vertx-nats-client:${maven.version}
----
...
See https://github.com/nats-io/nats.java#tls

=== Clusters & Reconnecting

See https://github.com/nats-io/nats.java#clusters--reconnecting

=== Tracing

TODO: integrate open tracing after NGCP-707 is completed.
